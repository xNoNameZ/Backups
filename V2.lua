...
_G.Settings = {
	...
	["Fruits"] = {
		["Select Main Fruits"] = {},
		["Select Second Fruits"] = {},
		["Auto Random Fruits"] = true,
		["Auto Find Fruits"] = true,
	}
}
...
spawn(function()
	while task.wait() do
		...
		if OldWorld then
			if MyLevel == 20 and <= 75 then
				Auto_Farm_Shanda = true
			elseif MyLevel >= 200 and not HaveItem("Saber") and HaveMob("Thunder God") then
