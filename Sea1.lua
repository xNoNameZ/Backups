...
_G.AntiCheat = {
	...
	["Enabled Monster"] = true,

	["Bring / Magnet Monster"] = true,
	...
	while task.wait() do
		pcall(function()
			...
			for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.AntiCheat["Bring / Magnet Monster"] then
...
task.spawn(function()
	game:GetService("RunService").Heartbeat:Connect(function()
		if Auto_Farm_Level or Auto_Farm_Nearest or Auto_New_World or Auto_Third_Sea or Auto_Farm_Boss or Auto_Super_Human or Auto_Death_Step or Auto_Sharkman_Karate or Auto_Electric_Claw or Auto_Dragon_Talon or Auto_GodHuman or Auto_Find_Saber or Auto_Pole or Auto_Rengoku or Auto_Cavander or Auto_Tushita or Auto_Cursed_Dual_Katana or Auto_Bartilo or Auto_Factory or Auto_Rainbow_Haki or Auto_MusketeerHat or Auto_Observation_V2 or Auto_HolyTorch or Farm_MagmaOre or Farm_AngelWing or Farm_Leather or Farm_ScrapMetal or Farm_Ectoplasm or Farm_Cocoa or Farm_Gunpowder or Farm_FishTail or Farm_DragonScale or Farm_MiniTuskthen then
...
task.spawn(function()
	pcall(function()
		while wait() do
			if Auto_Farm_Level or Auto_Farm_Nearest or Auto_New_World or Auto_Third_Sea or Auto_Farm_Boss or Auto_Super_Human or Auto_Death_Step or Auto_Sharkman_Karate or Auto_Electric_Claw or Auto_Dragon_Talon or Auto_GodHuman or Auto_Find_Saber or Auto_Pole or Auto_Rengoku or Auto_Cavander or Auto_Tushita or Auto_Cursed_Dual_Katana or Auto_Bartilo or Auto_Factory or Auto_Rainbow_Haki or Auto_MusketeerHat or Auto_Observation_V2 or Auto_HolyTorch or Farm_MagmaOre or Farm_AngelWing or Farm_Leather or Farm_ScrapMetal or Farm_Ectoplasm or Farm_Cocoa or Farm_Gunpowder or Farm_FishTail or Farm_DragonScale or Farm_MiniTuskthen == true then
	...
	while wait() do
		pcall(function()
			...
			if _G.Settings["Redeem All Code"] then
				if MyLevel >= _G.Settings["Redeem Code At Level"] then
					...
					wait(5)
					_G.Settings["Redeem All Code"] = false
				end
			end
		end)
	end
...
spawn(function()
	while task.wait() do
		if _G.Settings["Start Kaitun"] then
			...
			elseif game:GetService("Players").LocalPlayer.Data.Stats.Defense.Level.Value < 2600 and game:GetService("Players").LocalPlayer.Data.Stats.Melee.Level.Value == 2600 then
				local args = {
					[1] = "AddPoint",
					[2] = "Defense",
					[3] = 3
				...
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
			elseif game:GetService("Players").LocalPlayer.Data.Stats["Demon Fruit"].Level.Value < 1300 and game:GetService("Players").LocalPlayer.Data.Stats.Defense.Level.Value == 2600 then
			...
			if OldWorld then
				if MyLevel >= 15 and MyLevel <= 100 then
					Auto_Farm_Shanda = true
				elseif _G.Settings["Sea 1"]["Pole"] and MyLevel >= 100 and not HaveItem("Pole") and HaveMob("Thunder God") then
					Auto_Find_Poles = true
				elseif _G.Settings["Sea 1"]["Saber"] and MyLevel >= 200 and not HaveItem("Saber") then
					Auto_Find_Saber = true
...
spawn(function()
	while wait() do
		if Auto_Farm_Shanda and OldWorld then
			pcall(function()
						...
						if v.Name == "Shanda" then
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat task.wait()
									...
									game:GetService("VirtualUser"):CaptureController()
									game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
								until not Auto_Farm_Shanda or not v.Parent or v.Humanoid.Health <= 0
								StartMagnet = false
							end
						end
					end
				else
					ToTarget(CFrame.new(-7678.48974609375, 5566.40380859375, -497.2156066894531))
					if game:GetService("ReplicatedStorage"):FindFirstChild("Shanda") then
						ToTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Shanda").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
					end
				end
			end)
		end
...
task.spawn(function()
	pcall(function()
		while wait() do 
			if _G.Settings["Fighting Style"]["Superhuman"] then
				HightlightBody()
...
task.spawn(function()
	while task.wait() do
		if Auto_Find_Poles and OldWorld then
			pcall(function()
						...
						if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							if v.Name == "Thunder God" then
								repeat task.wait()
									...
									game:GetService'VirtualUser':CaptureController()
									game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672),workspace.CurrentCamera.CFrame)
								until not Auto_Find_Poles or not v.Parent or v.Humanoid.Health <= 0
							end
						end
					end
				else
			...
			pcall(function()
				...
				elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
					if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
						...
						if _G.AntiCheat["Enabled Monster"] then
							if MyLevel == 275 or MyLevel <= 299 then
								ToTarget(CFrameMon1 * CFrame.new(0,10, 0))
								wait(1)
								ToTarget(CFrameMon2 * CFrame.new(0,10, 0))
								wait(1)
								ToTarget(CFrameMon3 * CFrame.new(0,10, 0))
								wait(1)
								ToTarget(CFrameMon4 * CFrame.new(0,10, 0))
								wait(1)
								ToTarget(CFrameMon5 * CFrame.new(0,10, 0))
							end
						end
